...
<?php if ($subject->subcode->Visible) { // subcode ?>
		<th class="<?php echo $subject->subcode->HeaderCellClass() ?>"><span id="elh_subject_subcode" class="subject_subcode"><?php echo $subject->subcode->FldCaption() ?></span></th>
<?php } ?>
<?php if ($subject->title->Visible) { // title ?>
		<th class="<?php echo $subject->title->HeaderCellClass() ?>"><span id="elh_subject_title" class="subject_title"><?php echo $subject->title->FldCaption() ?></span></th>
<?php } ?>
<?php if ($subject->sem->Visible) { // sem ?>
		<th class="<?php echo $subject->sem->HeaderCellClass() ?>"><span id="elh_subject_sem" class="subject_sem"><?php echo $subject->sem->FldCaption() ?></span></th>
<?php } ?>
<?php if ($subject->totalmarks->Visible) { // totalmarks ?>
		<th class="<?php echo $subject->totalmarks->HeaderCellClass() ?>"><span id="elh_subject_totalmarks" class="subject_totalmarks"><?php echo $subject->totalmarks->FldCaption() ?></span></th>
<?php } ?>
<?php if ($subject->fid->Visible) { // fid ?>
		<th class="<?php echo $subject->fid->HeaderCellClass() ?>"><span id="elh_subject_fid" class="subject_fid"><?php echo $subject->fid->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($subject->subcode->Visible) { // subcode ?>
		<td<?php echo $subject->subcode->CellAttributes() ?>>
<span id="el<?php echo $subject_delete->RowCnt ?>_subject_subcode" class="subject_subcode">
...
<?php } ?>
<?php if ($subject->title->Visible) { // title ?>
		<td<?php echo $subject->title->CellAttributes() ?>>
<span id="el<?php echo $subject_delete->RowCnt ?>_subject_title" class="subject_title">
...
<?php } ?>
<?php if ($subject->sem->Visible) { // sem ?>
		<td<?php echo $subject->sem->CellAttributes() ?>>
<span id="el<?php echo $subject_delete->RowCnt ?>_subject_sem" class="subject_sem">
...
<?php } ?>
<?php if ($subject->totalmarks->Visible) { // totalmarks ?>
		<td<?php echo $subject->totalmarks->CellAttributes() ?>>
<span id="el<?php echo $subject_delete->RowCnt ?>_subject_totalmarks" class="subject_totalmarks">
...
<?php } ?>
<?php if ($subject->fid->Visible) { // fid ?>
		<td<?php echo $subject->fid->CellAttributes() ?>>
<span id="el<?php echo $subject_delete->RowCnt ?>_subject_fid" class="subject_fid">
