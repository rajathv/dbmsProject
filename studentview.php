...
class cstudent_view extends cstudent {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["usn"] <> "") {
			$this->RecKey["usn"] = $_GET["usn"];
			$KeyUrl .= "&amp;usn=" . urlencode($this->RecKey["usn"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["usn"] <> "") {
				...
				$this->RecKey["usn"] = $this->usn->QueryStringValue;
			} elseif (@$_POST["usn"] <> "") {
				$this->usn->setFormValue($_POST["usn"]);
				$this->RecKey["usn"] = $this->usn->FormValue;
			} else {
...
<?php if ($student->usn->Visible) { // usn ?>
	<tr id="r_usn">
		<td class="col-sm-2"><span id="elh_student_usn"><?php echo $student->usn->FldCaption() ?></span></td>
		<td data-name="usn"<?php echo $student->usn->CellAttributes() ?>>
<span id="el_student_usn">
<span<?php echo $student->usn->ViewAttributes() ?>>
<?php echo $student->usn->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($student->sem->Visible) { // sem ?>
	<tr id="r_sem">
		<td class="col-sm-2"><span id="elh_student_sem"><?php echo $student->sem->FldCaption() ?></span></td>
		<td data-name="sem"<?php echo $student->sem->CellAttributes() ?>>
<span id="el_student_sem">
<span<?php echo $student->sem->ViewAttributes() ?>>
<?php echo $student->sem->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($student->gender->Visible) { // gender ?>
	<tr id="r_gender">
		<td class="col-sm-2"><span id="elh_student_gender"><?php echo $student->gender->FldCaption() ?></span></td>
...
<?php echo $student->gender->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($student->backlogs->Visible) { // backlogs ?>
	<tr id="r_backlogs">
		<td class="col-sm-2"><span id="elh_student_backlogs"><?php echo $student->backlogs->FldCaption() ?></span></td>
...
<?php echo $student->backlogs->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($student->fid->Visible) { // fid ?>
	<tr id="r_fid">
		<td class="col-sm-2"><span id="elh_student_fid"><?php echo $student->fid->FldCaption() ?></span></td>
		<td data-name="fid"<?php echo $student->fid->CellAttributes() ?>>
<span id="el_student_fid">
<span<?php echo $student->fid->ViewAttributes() ?>>
<?php echo $student->fid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
