...
$result_edit = NULL; // Initialize page object first

class cresult_edit extends cresult {
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_rid")) {
				$this->rid->setFormValue($objForm->GetValue("x_rid"));
			}
		} else {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// usn
			$this->usn->SetDbValueDef($rsnew, $this->usn->CurrentValue, "", $this->usn->ReadOnly);

			// name
			$this->name->SetDbValueDef($rsnew, $this->name->CurrentValue, "", $this->name->ReadOnly);

			// sc1
			$this->sc1->SetDbValueDef($rsnew, $this->sc1->CurrentValue, "", $this->sc1->ReadOnly);

			// s1
			$this->s1->SetDbValueDef($rsnew, $this->s1->CurrentValue, 0, $this->s1->ReadOnly);

			// sc2
			$this->sc2->SetDbValueDef($rsnew, $this->sc2->CurrentValue, "", $this->sc2->ReadOnly);

			// s2
			$this->s2->SetDbValueDef($rsnew, $this->s2->CurrentValue, 0, $this->s2->ReadOnly);

			// sc3
			$this->sc3->SetDbValueDef($rsnew, $this->sc3->CurrentValue, 0, $this->sc3->ReadOnly);

			// s3
			$this->s3->SetDbValueDef($rsnew, $this->s3->CurrentValue, 0, $this->s3->ReadOnly);

			// sc4
			$this->sc4->SetDbValueDef($rsnew, $this->sc4->CurrentValue, 0, $this->sc4->ReadOnly);

			// s4
			$this->s4->SetDbValueDef($rsnew, $this->s4->CurrentValue, 0, $this->s4->ReadOnly);

			// sc5
			$this->sc5->SetDbValueDef($rsnew, $this->sc5->CurrentValue, 0, $this->sc5->ReadOnly);

			// s5
			$this->s5->SetDbValueDef($rsnew, $this->s5->CurrentValue, 0, $this->s5->ReadOnly);

			// sc6
			$this->sc6->SetDbValueDef($rsnew, $this->sc6->CurrentValue, 0, $this->sc6->ReadOnly);

			// s6
			$this->s6->SetDbValueDef($rsnew, $this->s6->CurrentValue, 0, $this->s6->ReadOnly);

			// sc7
			$this->sc7->SetDbValueDef($rsnew, $this->sc7->CurrentValue, 0, $this->sc7->ReadOnly);

			// s7
			$this->s7->SetDbValueDef($rsnew, $this->s7->CurrentValue, 0, $this->s7->ReadOnly);

			// sc8
			$this->sc8->SetDbValueDef($rsnew, $this->sc8->CurrentValue, 0, $this->sc8->ReadOnly);

			// s8
			$this->s8->SetDbValueDef($rsnew, $this->s8->CurrentValue, 0, $this->s8->ReadOnly);
...
// Create page object
if (!isset($result_edit)) $result_edit = new cresult_edit();

// Page init
$result_edit->Page_Init();

// Page main
$result_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$result_edit->Page_Render();
?>
...
var CurrentForm = fresultedit = new ew_Form("fresultedit", "edit");

// Validate form
fresultedit.Validate = function() {
...
fresultedit.Form_CustomValidate = 
...
fresultedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $result_edit->ShowPageHeader(); ?>
<?php
$result_edit->ShowMessage();
?>
<form name="fresultedit" id="fresultedit" class="<?php echo $result_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($result_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $result_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="result">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($result_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($result->rid->Visible) { // rid ?>
	<div id="r_rid" class="form-group">
		<label id="elh_result_rid" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->rid->FldCaption() ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->rid->CellAttributes() ?>>
<span id="el_result_rid">
<span<?php echo $result->rid->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $result->rid->EditValue ?></p></span>
</span>
<input type="hidden" data-table="result" data-field="x_rid" name="x_rid" id="x_rid" value="<?php echo ew_HtmlEncode($result->rid->CurrentValue) ?>">
<?php echo $result->rid->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($result->usn->Visible) { // usn ?>
	<div id="r_usn" class="form-group">
		<label id="elh_result_usn" for="x_usn" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->usn->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->usn->CellAttributes() ?>>
...
<?php if ($result->name->Visible) { // name ?>
	<div id="r_name" class="form-group">
		<label id="elh_result_name" for="x_name" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->name->CellAttributes() ?>>
...
<?php if ($result->sc1->Visible) { // sc1 ?>
	<div id="r_sc1" class="form-group">
		<label id="elh_result_sc1" for="x_sc1" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->sc1->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->sc1->CellAttributes() ?>>
...
<?php if ($result->s1->Visible) { // s1 ?>
	<div id="r_s1" class="form-group">
		<label id="elh_result_s1" for="x_s1" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->s1->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->s1->CellAttributes() ?>>
...
<?php if ($result->sc2->Visible) { // sc2 ?>
	<div id="r_sc2" class="form-group">
		<label id="elh_result_sc2" for="x_sc2" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->sc2->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->sc2->CellAttributes() ?>>
...
<?php if ($result->s2->Visible) { // s2 ?>
	<div id="r_s2" class="form-group">
		<label id="elh_result_s2" for="x_s2" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->s2->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->s2->CellAttributes() ?>>
...
<?php if ($result->sc3->Visible) { // sc3 ?>
	<div id="r_sc3" class="form-group">
		<label id="elh_result_sc3" for="x_sc3" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->sc3->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->sc3->CellAttributes() ?>>
...
<?php if ($result->s3->Visible) { // s3 ?>
	<div id="r_s3" class="form-group">
		<label id="elh_result_s3" for="x_s3" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->s3->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->s3->CellAttributes() ?>>
...
<?php if ($result->sc4->Visible) { // sc4 ?>
	<div id="r_sc4" class="form-group">
		<label id="elh_result_sc4" for="x_sc4" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->sc4->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->sc4->CellAttributes() ?>>
...
<?php if ($result->s4->Visible) { // s4 ?>
	<div id="r_s4" class="form-group">
		<label id="elh_result_s4" for="x_s4" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->s4->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->s4->CellAttributes() ?>>
...
<?php if ($result->sc5->Visible) { // sc5 ?>
	<div id="r_sc5" class="form-group">
		<label id="elh_result_sc5" for="x_sc5" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->sc5->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->sc5->CellAttributes() ?>>
...
<?php if ($result->s5->Visible) { // s5 ?>
	<div id="r_s5" class="form-group">
		<label id="elh_result_s5" for="x_s5" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->s5->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->s5->CellAttributes() ?>>
...
<?php if ($result->sc6->Visible) { // sc6 ?>
	<div id="r_sc6" class="form-group">
		<label id="elh_result_sc6" for="x_sc6" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->sc6->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->sc6->CellAttributes() ?>>
...
<?php if ($result->s6->Visible) { // s6 ?>
	<div id="r_s6" class="form-group">
		<label id="elh_result_s6" for="x_s6" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->s6->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->s6->CellAttributes() ?>>
...
<?php if ($result->sc7->Visible) { // sc7 ?>
	<div id="r_sc7" class="form-group">
		<label id="elh_result_sc7" for="x_sc7" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->sc7->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->sc7->CellAttributes() ?>>
...
<?php if ($result->s7->Visible) { // s7 ?>
	<div id="r_s7" class="form-group">
		<label id="elh_result_s7" for="x_s7" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->s7->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->s7->CellAttributes() ?>>
...
<?php if ($result->sc8->Visible) { // sc8 ?>
	<div id="r_sc8" class="form-group">
		<label id="elh_result_sc8" for="x_sc8" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->sc8->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->sc8->CellAttributes() ?>>
...
<?php if ($result->s8->Visible) { // s8 ?>
	<div id="r_s8" class="form-group">
		<label id="elh_result_s8" for="x_s8" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->s8->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->s8->CellAttributes() ?>>
...
<?php if ($result->total->Visible) { // total ?>
	<div id="r_total" class="form-group">
		<label id="elh_result_total" for="x_total" class="<?php echo $result_edit->LeftColumnClass ?>"><?php echo $result->total->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $result_edit->RightColumnClass ?>"><div<?php echo $result->total->CellAttributes() ?>>
...
<?php if (!$result_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $result_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $result_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
