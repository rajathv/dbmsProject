...
class csubject_list extends csubject {
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 1) {
			$this->subcode->setFormValue($arrKeyFlds[0]);
		}
		return TRUE;
	}
	...
	function GetFilterList() {
		...
		if (EW_SEARCH_FILTER_OPTION == "Server" && isset($UserProfile))
			$sSavedFilterList = $UserProfile->GetSearchFilters(CurrentUserName(), "fsubjectlistsrch");
		$sFilterList = ew_Concat($sFilterList, $this->subcode->AdvancedSearch->ToJson(), ","); // Field subcode
		$sFilterList = ew_Concat($sFilterList, $this->title->AdvancedSearch->ToJson(), ","); // Field title
		$sFilterList = ew_Concat($sFilterList, $this->sem->AdvancedSearch->ToJson(), ","); // Field sem
		$sFilterList = ew_Concat($sFilterList, $this->totalmarks->AdvancedSearch->ToJson(), ","); // Field totalmarks
	...
	function RestoreFilterList() {
		...
		// Field sem
		$this->sem->AdvancedSearch->SearchValue = @$filter["x_sem"];
		$this->sem->AdvancedSearch->SearchOperator = @$filter["z_sem"];
		$this->sem->AdvancedSearch->SearchCondition = @$filter["v_sem"];
		$this->sem->AdvancedSearch->SearchValue2 = @$filter["y_sem"];
		$this->sem->AdvancedSearch->SearchOperator2 = @$filter["w_sem"];
		$this->sem->AdvancedSearch->Save();

		// Field totalmarks
		$this->totalmarks->AdvancedSearch->SearchValue = @$filter["x_totalmarks"];
		$this->totalmarks->AdvancedSearch->SearchOperator = @$filter["z_totalmarks"];
		$this->totalmarks->AdvancedSearch->SearchCondition = @$filter["v_totalmarks"];
		$this->totalmarks->AdvancedSearch->SearchValue2 = @$filter["y_totalmarks"];
		$this->totalmarks->AdvancedSearch->SearchOperator2 = @$filter["w_totalmarks"];
		$this->totalmarks->AdvancedSearch->Save();
	...
	function BasicSearchSQL($arKeywords, $type) {
		$sWhere = "";
		$this->BuildBasicSearchSQL($sWhere, $this->subcode, $arKeywords, $type);
	...
	function SetupSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->sem); // sem
			$this->UpdateSort($this->totalmarks); // totalmarks
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" class=\"ewMultiSelect\" value=\"" . ew_HtmlEncode($this->subcode->CurrentValue) . "\" onclick=\"ew_ClickMultiCheckbox(event);\">";
	...
	function LoadRowValues($rs = NULL) {
		...
		$this->totalmarks->setDbValue($row['totalmarks']);
	...
	function LoadDbValues(&$rs) {
		...
		$this->totalmarks->DbValue = $row['totalmarks'];
	...
	function LoadOldRecord() {
		...
		$bValidKey = TRUE;
		if (strval($this->getKey("subcode")) <> "")
			$this->subcode->CurrentValue = $this->getKey("subcode"); // subcode
		else
			$bValidKey = FALSE;
	...
	function RenderRow() {
		...
		// totalmarks
		$this->totalmarks->ViewValue = $this->totalmarks->CurrentValue;
		$this->totalmarks->ViewCustomAttributes = "";
		...
		$this->fid->ViewCustomAttributes = "";
			...
			// totalmarks
			$this->totalmarks->LinkCustomAttributes = "";
			$this->totalmarks->HrefValue = "";
			$this->totalmarks->TooltipValue = "";
...
?>
<?php if ($subject->subcode->Visible) { // subcode ?>
	<?php if ($subject->SortUrl($subject->subcode) == "") { ?>
		<th data-name="subcode" class="<?php echo $subject->subcode->HeaderCellClass() ?>"><div id="elh_subject_subcode" class="subject_subcode"><div class="ewTableHeaderCaption"><?php echo $subject->subcode->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="subcode" class="<?php echo $subject->subcode->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $subject->SortUrl($subject->subcode) ?>',1);"><div id="elh_subject_subcode" class="subject_subcode">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $subject->subcode->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($subject->subcode->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($subject->subcode->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($subject->title->Visible) { // title ?>
	<?php if ($subject->SortUrl($subject->title) == "") { ?>
		<th data-name="title" class="<?php echo $subject->title->HeaderCellClass() ?>"><div id="elh_subject_title" class="subject_title"><div class="ewTableHeaderCaption"><?php echo $subject->title->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="title" class="<?php echo $subject->title->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $subject->SortUrl($subject->title) ?>',1);"><div id="elh_subject_title" class="subject_title">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $subject->title->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($subject->title->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($subject->title->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($subject->sem->Visible) { // sem ?>
	<?php if ($subject->SortUrl($subject->sem) == "") { ?>
		<th data-name="sem" class="<?php echo $subject->sem->HeaderCellClass() ?>"><div id="elh_subject_sem" class="subject_sem"><div class="ewTableHeaderCaption"><?php echo $subject->sem->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="sem" class="<?php echo $subject->sem->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $subject->SortUrl($subject->sem) ?>',1);"><div id="elh_subject_sem" class="subject_sem">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $subject->sem->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($subject->sem->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($subject->sem->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($subject->totalmarks->Visible) { // totalmarks ?>
	<?php if ($subject->SortUrl($subject->totalmarks) == "") { ?>
		<th data-name="totalmarks" class="<?php echo $subject->totalmarks->HeaderCellClass() ?>"><div id="elh_subject_totalmarks" class="subject_totalmarks"><div class="ewTableHeaderCaption"><?php echo $subject->totalmarks->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="totalmarks" class="<?php echo $subject->totalmarks->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $subject->SortUrl($subject->totalmarks) ?>',1);"><div id="elh_subject_totalmarks" class="subject_totalmarks">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $subject->totalmarks->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($subject->totalmarks->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($subject->totalmarks->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($subject->fid->Visible) { // fid ?>
	<?php if ($subject->SortUrl($subject->fid) == "") { ?>
		<th data-name="fid" class="<?php echo $subject->fid->HeaderCellClass() ?>"><div id="elh_subject_fid" class="subject_fid"><div class="ewTableHeaderCaption"><?php echo $subject->fid->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="fid" class="<?php echo $subject->fid->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $subject->SortUrl($subject->fid) ?>',1);"><div id="elh_subject_fid" class="subject_fid">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $subject->fid->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($subject->fid->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($subject->fid->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
?>
	<?php if ($subject->subcode->Visible) { // subcode ?>
		<td data-name="subcode"<?php echo $subject->subcode->CellAttributes() ?>>
<span id="el<?php echo $subject_list->RowCnt ?>_subject_subcode" class="subject_subcode">
<span<?php echo $subject->subcode->ViewAttributes() ?>>
<?php echo $subject->subcode->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($subject->title->Visible) { // title ?>
		<td data-name="title"<?php echo $subject->title->CellAttributes() ?>>
<span id="el<?php echo $subject_list->RowCnt ?>_subject_title" class="subject_title">
<span<?php echo $subject->title->ViewAttributes() ?>>
<?php echo $subject->title->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($subject->sem->Visible) { // sem ?>
		<td data-name="sem"<?php echo $subject->sem->CellAttributes() ?>>
<span id="el<?php echo $subject_list->RowCnt ?>_subject_sem" class="subject_sem">
<span<?php echo $subject->sem->ViewAttributes() ?>>
<?php echo $subject->sem->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($subject->totalmarks->Visible) { // totalmarks ?>
		<td data-name="totalmarks"<?php echo $subject->totalmarks->CellAttributes() ?>>
<span id="el<?php echo $subject_list->RowCnt ?>_subject_totalmarks" class="subject_totalmarks">
<span<?php echo $subject->totalmarks->ViewAttributes() ?>>
<?php echo $subject->totalmarks->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($subject->fid->Visible) { // fid ?>
		<td data-name="fid"<?php echo $subject->fid->CellAttributes() ?>>
<span id="el<?php echo $subject_list->RowCnt ?>_subject_fid" class="subject_fid">
<span<?php echo $subject->fid->ViewAttributes() ?>>
<?php echo $subject->fid->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
