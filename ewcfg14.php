...
define("EW_PROJECT_ID", "{7dac28fc-e6ee-49d2-b722-398a2b30146f}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'b44xsHTs9YHfACer', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "rajath", "qs" => "`", "qe" => "`");
...
define("EW_ADMIN_PASSWORD", "pass1234", TRUE); // Administrator password
