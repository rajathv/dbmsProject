...
class cstudent_list extends cstudent {
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 1) {
			$this->usn->setFormValue($arrKeyFlds[0]);
		}
		return TRUE;
	}
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->backlogs->AdvancedSearch->ToJson(), ","); // Field backlogs
	...
	function RestoreFilterList() {
		...
		// Field backlogs
		$this->backlogs->AdvancedSearch->SearchValue = @$filter["x_backlogs"];
		$this->backlogs->AdvancedSearch->SearchOperator = @$filter["z_backlogs"];
		$this->backlogs->AdvancedSearch->SearchCondition = @$filter["v_backlogs"];
		$this->backlogs->AdvancedSearch->SearchValue2 = @$filter["y_backlogs"];
		$this->backlogs->AdvancedSearch->SearchOperator2 = @$filter["w_backlogs"];
		$this->backlogs->AdvancedSearch->Save();
	...
	function SetupSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->backlogs); // backlogs
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" class=\"ewMultiSelect\" value=\"" . ew_HtmlEncode($this->usn->CurrentValue) . "\" onclick=\"ew_ClickMultiCheckbox(event);\">";
...
<?php if ($student->usn->Visible) { // usn ?>
	<?php if ($student->SortUrl($student->usn) == "") { ?>
		<th data-name="usn" class="<?php echo $student->usn->HeaderCellClass() ?>"><div id="elh_student_usn" class="student_usn"><div class="ewTableHeaderCaption"><?php echo $student->usn->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="usn" class="<?php echo $student->usn->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $student->SortUrl($student->usn) ?>',1);"><div id="elh_student_usn" class="student_usn">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $student->usn->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($student->usn->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($student->usn->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($student->sem->Visible) { // sem ?>
	<?php if ($student->SortUrl($student->sem) == "") { ?>
		<th data-name="sem" class="<?php echo $student->sem->HeaderCellClass() ?>"><div id="elh_student_sem" class="student_sem"><div class="ewTableHeaderCaption"><?php echo $student->sem->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="sem" class="<?php echo $student->sem->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $student->SortUrl($student->sem) ?>',1);"><div id="elh_student_sem" class="student_sem">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $student->sem->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($student->sem->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($student->sem->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($student->gender->Visible) { // gender ?>
	<?php if ($student->SortUrl($student->gender) == "") { ?>
		<th data-name="gender" class="<?php echo $student->gender->HeaderCellClass() ?>"><div id="elh_student_gender" class="student_gender"><div class="ewTableHeaderCaption"><?php echo $student->gender->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="gender" class="<?php echo $student->gender->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $student->SortUrl($student->gender) ?>',1);"><div id="elh_student_gender" class="student_gender">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $student->gender->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($student->gender->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($student->gender->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($student->backlogs->Visible) { // backlogs ?>
	<?php if ($student->SortUrl($student->backlogs) == "") { ?>
		<th data-name="backlogs" class="<?php echo $student->backlogs->HeaderCellClass() ?>"><div id="elh_student_backlogs" class="student_backlogs"><div class="ewTableHeaderCaption"><?php echo $student->backlogs->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="backlogs" class="<?php echo $student->backlogs->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $student->SortUrl($student->backlogs) ?>',1);"><div id="elh_student_backlogs" class="student_backlogs">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $student->backlogs->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($student->backlogs->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($student->backlogs->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($student->fid->Visible) { // fid ?>
	<?php if ($student->SortUrl($student->fid) == "") { ?>
		<th data-name="fid" class="<?php echo $student->fid->HeaderCellClass() ?>"><div id="elh_student_fid" class="student_fid"><div class="ewTableHeaderCaption"><?php echo $student->fid->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="fid" class="<?php echo $student->fid->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $student->SortUrl($student->fid) ?>',1);"><div id="elh_student_fid" class="student_fid">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $student->fid->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($student->fid->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($student->fid->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
?>
	<?php if ($student->usn->Visible) { // usn ?>
		<td data-name="usn"<?php echo $student->usn->CellAttributes() ?>>
<span id="el<?php echo $student_list->RowCnt ?>_student_usn" class="student_usn">
...
<?php echo $student->name->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($student->sem->Visible) { // sem ?>
		<td data-name="sem"<?php echo $student->sem->CellAttributes() ?>>
<span id="el<?php echo $student_list->RowCnt ?>_student_sem" class="student_sem">
...
<?php echo $student->_email->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($student->gender->Visible) { // gender ?>
		<td data-name="gender"<?php echo $student->gender->CellAttributes() ?>>
<span id="el<?php echo $student_list->RowCnt ?>_student_gender" class="student_gender">
...
<?php echo $student->gender->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($student->backlogs->Visible) { // backlogs ?>
		<td data-name="backlogs"<?php echo $student->backlogs->CellAttributes() ?>>
<span id="el<?php echo $student_list->RowCnt ?>_student_backlogs" class="student_backlogs">
...
<?php echo $student->backlogs->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($student->fid->Visible) { // fid ?>
		<td data-name="fid"<?php echo $student->fid->CellAttributes() ?>>
<span id="el<?php echo $student_list->RowCnt ?>_student_fid" class="student_fid">
